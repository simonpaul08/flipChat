        ...
        <div className="landing-container">
          ...
          <section className="landing-header">
            ...
            <div className="landing-header-nav">
              ...
              <a href="#pricing" className='landing-nav-item'>Pricing</ a>
          ...
          <section className="landing-showcase">
            <div className="landing-grid-left">
              ...
              <h1 className='showcase-title showcase-title-green'>WhatsApp links</h1>
              <p className='showcase-para'>Build you brand’s recognition and how get detailed insights on how your links are performing</p>
              <button className='showcase-cta btn-primary'>Generate WhatsApp Link</button>
            </div>
            <div className="landing-grid-right">
              <img src={ShowcaseBG} alt="showcase background image" className='showcase-bg' />
            </div>
          </section>
          ...
          <section id='features' className='landing-features'>
            ...
            <p className='landing-features-para'>Automatically distribute chats between multiple agents (WhatsApp lines) using one single link.</p>
        ...
        <div className="sub-features">
          <div className="landing-container">
            ...
            <form className='landing-find'>
              <input type="text" className='landing-find-input' name='name' id='name' placeholder='Enter your brand name...' />
              <button className='btn-primary landing-find-cta'> <img src={SearchIcon} className='landing-find-cta-icon' />Search FlipChat Link</button>
            </form>
          </div>
        </div>
          ...
          <div className="landing-container">
            ...
            <div className="landing-price-grid">
              <div className="price-grid-left">
                <p className='landing-features-para'>WhatsApp click to chat links with enhanced features that drive more customers to your chat</p>
                <div className='price-features'>
                  <div className='price-features-item'>
                    <img src={CheckIcon} alt="check icon" className='price-features-item-icon' />
                    <p className='price-features-item-para'>Branded links, FlipChat.link/YourBrand</p>
                  </div>
                  <div className='price-features-item'>
                    <img src={CheckIcon} alt="check icon" className='price-features-item-icon' />
                    <p className='price-features-item-para'>Clicks analytics by hour, day and month</p>
                  </div>
                  <div className='price-features-item'>
                    <img src={CheckIcon} alt="check icon" className='price-features-item-icon' />
                    <p className='price-features-item-para'>Edit phone, user message and URL anytime</p>
                  </div>
                  <div className='price-features-item'>
                    <img src={CheckIcon} alt="check icon" className='price-features-item-icon' />
                    <p className='price-features-item-para'>Appear as a result in our search engine</p>
                  </div>
                  <div className='price-features-item'>
                    <img src={CheckIcon} alt="check icon" className='price-features-item-icon' />
        ...
        <section id='footer' className='landing-footer'>
          <div className="landing-container">
            <div className='landing-footer-head'>
              <img src={MailIcon} alt='mail icon' className='landing-footer-head-icon' />
              <h3 className='landing-footer-head-title'>React Out Today</h3>
            </div>

            <p className='landing-footer-para'>Flipchat.link is neither associated with nor sponsored by WhatsApp LLC or Meta Platforms, Inc. We offer a service based on WhatsApp’s public API. By using our service, you are accepting our terms of service and privacy policy.</p>
